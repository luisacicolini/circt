...
(assert (forall ((var0 Int) (time Int))
  (! (=> (= time 0) (tr01 0 time)) :weight 0)))
(assert (forall ((var0 Int) (time Int))
  (! (=> (and (tr01 var0 time) true true) (tr12 (+ var0 1) (+ time 1)))
     :weight 0)))
(assert (forall ((var0 Int) (time Int))
...
(assert (forall ((var0 Int) (time Int))
  (! (=> (and (tr34 var0 time) true true) (tr45 (+ var0 1) (+ time 1)))
     :weight 0)))
(assert (forall ((var0 Int) (time Int))
  (! (=> (and (tr45 var0 time) true true) (tr23 (+ var0 1) (+ time 1)))
     :weight 0)))
(assert (forall ((var0 Int) (time Int))
...
; comb (works)
(assert (forall ((var0 Int) (time Int))
  (! (=> (tr23 var0 time) (= var0 2)) :weight 0)))
(check-sat)
(get-model)