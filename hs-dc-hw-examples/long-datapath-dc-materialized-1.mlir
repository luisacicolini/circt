module {
  hw.module @ops(in %arg0 : !dc.value<i32>, in %arg1 : !dc.value<i32>, in %arg2 : !dc.value<i32>, in %arg3 : !dc.value<i32>, in %arg4 : !dc.value<i32>, in %clk : !dc.value<i32>, in %rst : !dc.value<i32>, in %clk_0 : !seq.clock {dc.clock}, in %rst_0 : i1 {dc.reset}, out out0 : !dc.value<i32>, out out1 : !dc.value<i32>, out out2 : !dc.token) {
    ...
    %16 = comb.sub %output_23, %output_25 : i32
    ...
    %19 = comb.sub %output_27, %output_29 : i32
    ...
    %25 = comb.mul %output_33, %output_35 : i32
    ...
    %28 = comb.divs %output_37, %output_39 : i32
    ...
    %34 = comb.divu %output_43, %output_45 : i32
    ...
    %37 = comb.divs %output_47, %output_49 : i32
    ...
    %43 = comb.divu %output_53, %output_55 : i32
    ...
    %50 = comb.mul %output_59, %output_61 : i32
    ...
    %56 = comb.divs %output_65, %output_67 : i32
    ...
    %62 = comb.and %output_71, %output_73 : i32
    ...
    %65 = comb.or %output_75, %output_77 : i32
    ...
    %68 = comb.xor %output_79, %output_81 : i32
