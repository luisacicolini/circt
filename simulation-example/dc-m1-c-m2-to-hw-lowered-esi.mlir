module {
  hw.module @test_control_merge(in %arg0 : i0, in %arg0_valid : i1, in %arg1 : i0, in %arg1_valid : i1, in %clk : !seq.clock, in %rst : i1, in %out0_ready : i1, in %out1_ready : i1, out arg0_ready : i1, out arg1_ready : i1, out out0 : i0, out out0_valid : i1, out out1 : index, out out1_valid : i1) {
    ...
    %18 = arith.index_cast %rawOutput_6 : i1 to index
    %rawOutput_19, %valid_20 = esi.unwrap.vr %chanOutput_13, %ready_22 : i0
    %chanOutput_21, %ready_22 = esi.wrap.vr %18, %valid_20 : index
    %rawOutput_23, %valid_24 = esi.unwrap.vr %chanOutput_16, %out0_ready : i0
    %rawOutput_25, %valid_26 = esi.unwrap.vr %chanOutput_21, %out1_ready : index
    hw.output %ready_1, %ready, %rawOutput_23, %valid_24, %rawOutput_25, %valid_26 : i1, i1, i0, i1, index, i1
  }
}
