module {
  hw.module @test_control_merge(in %arg0 : !esi.channel<i0>, in %arg1 : !esi.channel<i0>, in %clk : !seq.clock {dc.clock}, in %rst : i1 {dc.reset}, out out0 : !esi.channel<i0>, out out1 : !esi.channel<i1>) {
    ...
    %chanOutput_17, %ready_18 = esi.wrap.vr %rawOutput_2, %valid_16 : i1
    hw.output %chanOutput_12, %chanOutput_17 : !esi.channel<i0>, !esi.channel<i1>
  }
}
