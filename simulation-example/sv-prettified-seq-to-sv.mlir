module {
  hw.module @test_control_merge(in %arg0 : i0, in %arg0_valid : i1, in %arg1 : i0, in %arg1_valid : i1, in %clk : i1, in %rst : i1, in %out0_ready : i1, in %out1_ready : i1, out arg0_ready : i1, out arg1_ready : i1, out out0 : i0, out out0_valid : i1, out out1 : index, out out1_valid : i1) {
    ...
    hw.output %2, %4, %c0_i0, %16, %21, %9 : i1, i1, i0, i1, index, i1
  }
}
