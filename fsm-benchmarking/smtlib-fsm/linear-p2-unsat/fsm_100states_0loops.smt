...
(assert
 ...
 (let (($x38 (= ?x37 (- 1))))
 (=> (and (> time2 time) (= (time-to-state time) 100)) $x38))))
 )
(assert
...
(assert
 ...
 (let (($x35 (>= time 0)))
 (let (($x84 (and $x35 (< time 500))))
 (=> (and $x84 $x1378) (and (= (time-to-state (+ time 1)) 100) $x78))))))))
 )
(assert
 (forall ((time Int) )(let ((?x37 (time-to-state time)))
 (let (($x1378 (= ?x37 99)))
 (let (($x35 (>= time 0)))
 (let (($x84 (and $x35 (< time 200))))
 (=> $x84 (and (distinct $x1378 (and (= (var0_0 time) 99) true)) true)))))))
 )
(check-sat)
