...
(assert (forall ((input0 Int)
         ...
         (var1_p Int)
         (time_p Int))
  (! (=> (and (>= time 0) (< time 4)) (input_arg0 0 0 var1 var1_p time time_p)) :weight 0)))
(assert (forall ((input0 Int)
         (var1 Int)
         (time Int)
         (input0_p Int)
         (var1_p Int)
         (time_p Int))
  (! (=> (and (>= time 4) (< time 10)) (input_arg0 1 1 var1 var1_p time time_p)) :weight 0)))
(assert (forall ((input0 Int)
         (var1 Int)
         (time Int)
         (input0_p Int)
...
; reachability -> always unsat for some reason?
(assert (forall ((input0 Int) (var1 Int) (time Int))
